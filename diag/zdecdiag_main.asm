;
; zdecdiag_main.asm - ELF-DOS front end for the Z-text decoder
; diagnostics
;
; Usage: ZDECDIAG
;
; Runs zdecdiag.asm's zddiag_run against the Z-text decoder
; (zdec.asm) and reports PASS/FAIL per check plus a summary line, all
...
zd_store_flag:
            ...
            call    K_INMSG
            db      "check 0 (decode 'hello'): ",0
            mov     rb, zd_results+0
            call    zd_report

            call    K_INMSG
            db      "check 1 (decode 'Hi', A1 shift): ",0
            mov     rb, zd_results+1
            call    zd_report
