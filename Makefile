...
# diag/zdiag_main and diag/zobjdiag_main are ELF-DOS front ends for
# zdiag.asm/zobjdiag.asm's checks against the resident memory/stack and
# object/attribute primitives (see docs/ARCHITECTURE.md's "diagnostic
...
clean:
	...
	rm -f diag/zdiag diag/zdiag.lkb diag/zobjdiag diag/zobjdiag.lkb